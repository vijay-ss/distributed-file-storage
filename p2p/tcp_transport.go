...
type TCPPeer struct {
	// The underlying connection of the peer, in this case TCP connection.
	net.Conn
...
// Addr implements the Transport interface, returning the
// address the transport is accepting connections.
